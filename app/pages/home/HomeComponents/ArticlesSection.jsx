  ...
  return (
    <div>
      <section className="relative bg-[#f3efe6] py-8 sm:py-10 md:py-12 lg:pt-22">
        ...
        <div
          className="w-full md:w-50 mt-5 md:mt-0  flex items-center justify-center mb-6 md:mb-0
             ...
             2xl:absolute 2xl:top-48 2xl:-left-20 2xl:-rotate-90"
          style={{
            backgroundColor: "#f5e19c",
            height: "40px",
          }}
        >
          <span className="whitespace-nowrap text-xs font-semibold tracking-wider text-[#ab8547] md:text-base lg:text-[20px]">
            Featured Articles
          </span>
        </div>
